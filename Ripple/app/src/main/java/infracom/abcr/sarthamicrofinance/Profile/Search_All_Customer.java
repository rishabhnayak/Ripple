...
public class Search_All_Customer extends AppCompatActivity {
    ...
    ArrayList<String> listsub12 = new ArrayList<String>();
    ArrayList<String> listsub13 = new ArrayList<String>();
    ArrayList<String> listsub14 = new ArrayList<String>();
    ArrayList<String> listsub15 = new ArrayList<String>();
    ArrayList<String> listsub16 = new ArrayList<String>();
    ...
    private Search_All_Customer mActivity;
    ...
    ImageView Cadd, CaddV, CaddA, CaddD,CCCCC,DDDD,CaddI,CaddB1, CaddB2;
    ...
    private  String Manager_Profile_Query_Send_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Manager_Quary_Profile.php";
    private  String Manager_Finance_Query_Send_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Manager_Quary_Finance.php";
    private  String Admin_Finance_Query_Send_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Admin_Quary_Finance.php";
    ...
    private  String Install_Summ_LongOperation_url="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Install_Summ_LongOperation.php";


    private static Bitmap bm;
    static Bitmap bitmap;
    private String SERVER_URL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/updateProfile.php";

    private String Customer_uSERVER_URL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/report_customer_details.php";
    ...
    private  String ApproveSend_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/ManagerApprove.php";

    private  String ApproveSend_Link2="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/ManagerDecline.php";


    private  String SApproveSend_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/SalesApprove.php";

    private  String SApproveSend_LinkANS="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/SalesApproveANS.php";

    private  String FinancialDetailANS="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Financial_SalesApproveANS.php";

    private  String SApproveSend_Link2="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/SalesDecline.php";

    private  String FINANCeApproveSend_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Finance_ManagerApprove.php";

    private  String FINANCeApproveSend_Link2ANS="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Finance_ManagerQANS.php";

    private  String FINANCeApproveSend_Link2="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Finance_ManagerDecline.php";

    private  String Admin_AApproveSend_Link="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Admin_Approve.php";

    private  String Admin_AApproveSend_Link2="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Admin_Decline.php";

    private  String SMSCASNC_url="https://sarthamicrofinance.com/admin/pages/forms/pdffolder/TCPDF-master/examples/mail/appsms.php";
    ...
    static String img1,img2,img3,img4, Name,Fname,tunMobile, Address,City,Zip,Xiemail,XPan="",lat,lon,product_name ;
    ...
    private static final String TAG = Search_All_Customer.class.getSimpleName();
...
public    String dob1 ,Pemail;
    ...
    LinearLayout listViewReplacement, listViewReplacement1;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.search__all__customer);
...
//        button11ANS.setVisibility(View.GONE);
        ...
        if (!aController.isConnectingToInternet()) {
            ...
            aController.showAlertDialog(Search_All_Customer.this,
...
/*
        ...
        SB1="SB";
        CompoundButton.OnCheckedChangeListener listener23 = new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        SB.setOnCheckedChangeListener(listener23);
        CA.setOnCheckedChangeListener(listener23);
        CC.setOnCheckedChangeListener(listener23);
*/
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonP 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonP);
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonD 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonD);
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonA 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonA);
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonV 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonV);

        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton imageButtonDISBUS 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonDISBUS);
        ...
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton CCCCC1 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonDISBUS);
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton DDDD1 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonB);

        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonI 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonI);
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonB1 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonB1);
        infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton buttonB2 	= (infracom.abcr.sarthamicrofinance.material.widget.FloatingActionButton) findViewById(R.id.imageButtonB2);
        ...
        buttonB1.setVisibility(View.GONE);
        buttonB2.setVisibility(View.GONE);
...
*/
        ...
        gps = new GPSTracker(Search_All_Customer.this);
...
//mylistview1.setAdapter(adapter);
        listViewReplacement = (LinearLayout) findViewById(R.id.pppp);
//mylistview1.setAdapter(adapter);
        listViewReplacement1 = (LinearLayout) findViewById(R.id.pppp1);
...
*/
      ...
      //  listViewReplacement = null;
      //  listViewReplacement1 = null;
            ...
            public void onClick(DialogInterface dialog, int item) { // pick from
                ...
                if (item == 0) {
                    ...
                    if (storageState.equals(Environment.MEDIA_MOUNTED)) {
                        ...
                        new AlertDialog.Builder(Search_All_Customer.this)
                                .setMessage(
...
*/
        ...
        CaddI 	= (ImageView) findViewById(R.id.imageViewI);
        CaddB1 	= (ImageView) findViewById(R.id.imageViewB1);
        CaddB2 	= (ImageView) findViewById(R.id.imageViewB2);


        bt1 	= (FancyButton) findViewById(R.id.refresh2);
        bt2 	= (FancyButton) findViewById(R.id.refresh3);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Install_Summ_LongOperation().execute(Install_Summ_LongOperation_url,cid,"","");
            }
        });
...
//        ImagePopup.enablePopUpOnClick(this, CCCCC);
  //      ImagePopup.enablePopUpOnClick(this, DDDD);


        FancyButton sanct = (FancyButton)findViewById(R.id.TaskCustomerDe);
        FancyButton refr = (FancyButton)findViewById(R.id.TaskLoanDetails);

        FancyButton searchn = (FancyButton)findViewById(R.id.TaskLoan);
        FancyButton home = (FancyButton)findViewById(R.id.Taskmessage);
        ...
        refr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // listViewReplacement1 = null;
                ...
                new Approve_Summ_LongOperation().execute(Approve_Summ_LongOperation_url,cid,"","");
                new CustomerLongOperation().execute(Customer_uSERVER_URL,cid,"","");
                new Install_Summ_LongOperation().execute(Install_Summ_LongOperation_url,cid,"","");
            }
        });
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Search_All_Customer.this, Main.class);
...
//                intent.putExtra("cid", cc);
        ...
        FancyButton TaskLoanDetailggs = (FancyButton)findViewById(R.id.TaskLoanDetailggs);

        TaskLoanDetailggs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new CustomerLongOperation().execute(Customer_uSERVER_URL,cid,"","");
       ...
       ImagePopup.enablePopUpOnClick(this, CaddI);
       ImagePopup.enablePopUpOnClick(this, CaddB1);
       ImagePopup.enablePopUpOnClick(this, CaddB2);

     ImagePopup.enablePopUpOnClick(this, CCCCC);
      ImagePopup.enablePopUpOnClick(this, DDDD);

        sanct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SanctionSend();
            }
    ...
    public void SanctionSend(){
        ...
        builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog){
            ...
            protected void onBuildDone(Dialog dialog) {
                ...
                EditText emailPrime = (EditText)dialog.findViewById(R.id.emailPrime);
                emailPrime.setText(Pemail.toString().trim());

            }
            @Override
            public void onPositiveActionClicked(DialogFragment fragment) {

                    EditText emailPrime = (EditText)fragment.getDialog().findViewById(R.id.emailPrime);
                    EditText Prime = (EditText)fragment.getDialog().findViewById(R.id.Prime);
                    //Toast.makeText(mActivity, "Connected", Toast.LENGTH_SHORT).show();
                   // emailPrime.setText(Pemail.toString().trim());
                    final String  ccc=emailPrime.getText().toString().trim();
                    final String  ccc2=Prime.getText().toString().trim();

                    if(ccc.toString().trim().equals("")){
                        Toast.makeText(getApplicationContext(), "Please Enter Customer Email ID.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    if(ccc2.toString().trim().equals("")){
                        Toast.makeText(getApplicationContext(), "Please Enter Insurance Premium(Paid Upfront)", Toast.LENGTH_SHORT).show();
                   return;
                    }else{
                        //Intent intent = new Intent(Search_All_Customer.this, Search_All_Customer.class);
                        //intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                        //intent.putExtra("cname", "KJJHFDID");
                        //intent.putExtra("cid", cc);
                        //intent.putExtra("sts", "QUERY");
...
//showBottomSheet(appro);
                        emailPrime = (EditText)fragment.getDialog().findViewById(R.id.emailPrime);
                        Prime = (EditText)fragment.getDialog().findViewById(R.id.Prime);
                        //Toast.makeText(mActivity, "Connected", Toast.LENGTH_SHORT).show();
                        //emailPrime.setText(Pemail.toString().trim());
                     final String   Sccc=emailPrime.getText().toString().trim();
                     final String   Sccc2=Prime.getText().toString().trim();
                        ...
                        builder
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        String Sank="https://sarthamicrofinance.com/admin/pages/forms/pdffolder/TCPDF-master/examples/senction.php?uid="+cid+"&insurance="+ccc2;

                                        new SanctionSindCustomer().execute(SMSCASNC_url,cid,Sccc,Sccc2,product_name);
        ...
        builder.title("Sanction Letter")
                .positiveAction("Send")
                .negativeAction("CANCEL")
                .contentView(R.layout.send_sanction_letter);
...
//    new ManagerApprove().execute(SApproveSend_Link,cid,cname,deviceIMEI,empname,regid,MSG,lat,lon);
    ...
    public  void Submit(){
        ...
        if(dob1.trim().length() < 1){
            Toast.makeText(Search_All_Customer.this, "Please Select DOB", Toast.LENGTH_SHORT).show();
            return;
        }
...
*/
                                                                                    ...
                                                                                    if(no_year_current1.trim().length() > 0){
                                                                                        if(productD1.trim().length() > 2){
                                                                                            ...
                                                                                            if(OccupationS.trim().length() < 2){
                                                                                                Toast.makeText(Search_All_Customer.this, "Please Select Qualification", Toast.LENGTH_SHORT).show();
                                                                                                return;
                                                                                            }
                                                                                            if(OuaS.trim().length() < 2){
                                                                                                Toast.makeText(Search_All_Customer.this, "Please Select Occupation", Toast.LENGTH_SHORT).show();
                                                                                                return;
                                                                                            }
                                                                                            ...
                                                                                            if(under_depart.equals("Sales Person")) {
                                                                                                if (checkPhoto.equals("null") || checkPhoto.equals("")) {
                                                                                                    Toast.makeText(Search_All_Customer.this, "Please Take Photo", Toast.LENGTH_SHORT).show();return;
                                                                                                }
                                                                                                if (checkPhoto2.equals("null") || checkPhoto2.equals("")) {
                                                                                                    Toast.makeText(Search_All_Customer.this, "Please Take Aahhar Image", Toast.LENGTH_SHORT).show();return;

                                                                                                }
                                                                                                if (checkPhoto3.equals("null") || checkPhoto3.equals("")) {
                                                                                                    Toast.makeText(Search_All_Customer.this, "Please Take PAN Card Image", Toast.LENGTH_SHORT).show();return;

                                                                                                }
                                                                                                if (checkPhoto4.equals("null") || checkPhoto4.equals("")) {
                                                                                                    Toast.makeText(Search_All_Customer.this, "Please Take Address Pro0f Image", Toast.LENGTH_SHORT).show();return;
                                                                                            ...
                                                                                            //           }else{Toast.makeText(Search_All_Customer.this, "Please Take Address Prof Image", Toast.LENGTH_SHORT).show();return;}
                                                                                            //           }else{Toast.makeText(Search_All_Customer.this, "Please Take Pan Card Image", Toast.LENGTH_SHORT).show();return;}
                                                                                            //        }else{Toast.makeText(Search_All_Customer.this, "Please Take Aadhar Card Image", Toast.LENGTH_SHORT).show();return;}
                                                                                            //        }else{Toast.makeText(Search_All_Customer.this, "Please Take Customer Photo", Toast.LENGTH_SHORT).show();return;}


                                                                                        }else{Toast.makeText(Search_All_Customer.this, "Please Enter Product Details", Toast.LENGTH_SHORT).show();return;}

                                                                                    }else{Toast.makeText(Search_All_Customer.this, "Please Enter No of year current Residence", Toast.LENGTH_SHORT).show();return;}
                                                                                }else{Toast.makeText(Search_All_Customer.this, "Please Enter Father Name", Toast.LENGTH_SHORT).show();return;}

                                                                            }else{Toast.makeText(Search_All_Customer.this, "Please Enter Annual Income ", Toast.LENGTH_SHORT).show();return;}

                                                                        }else{Toast.makeText(Search_All_Customer.this, "Please Enter Nationality", Toast.LENGTH_SHORT).show();return;}
                                                                        // }else{Toast.makeText(Search_All_Customer.this, "Please Residence Contact", Toast.LENGTH_SHORT).show();return;}

                                                                    }else{Toast.makeText(Search_All_Customer.this, "Please Residence Address", Toast.LENGTH_SHORT).show();return;}

                                                                }else{Toast.makeText(Search_All_Customer.this, "Please Enter Residence Address Land Mark", Toast.LENGTH_SHORT).show();return;}
                                                            }else{Toast.makeText(Search_All_Customer.this, "Please Enter Residence Address State", Toast.LENGTH_SHORT).show();return;}
                                                        }else{Toast.makeText(Search_All_Customer.this, "Please Enter Residence Address City", Toast.LENGTH_SHORT).show();return;}
                                                    }else{Toast.makeText(Search_All_Customer.this, "Please Enter Residence Address PIN", Toast.LENGTH_SHORT).show();return;}
                                                    //   }else{Toast.makeText(Search_All_Customer.this, "Please Enter DL", Toast.LENGTH_SHORT).show();return;}
                                                    //  }else{Toast.makeText(Search_All_Customer.this, "Please Enter Aadhar Number", Toast.LENGTH_SHORT).show();return;}
                                                }else{Toast.makeText(Search_All_Customer.this, "Please Enter No of Dependents", Toast.LENGTH_SHORT).show();return;}
                                            }else{Toast.makeText(Search_All_Customer.this, "Please Select DOB", Toast.LENGTH_SHORT).show();return;}
                                        }else{Toast.makeText(Search_All_Customer.this, "Please Enter Mother Name", Toast.LENGTH_SHORT).show();return;}


                                    }else{Toast.makeText(Search_All_Customer.this, "Please Enter PAN Number", Toast.LENGTH_SHORT).show();return;}

                                }else{Toast.makeText(Search_All_Customer.this, "Please Enter Email ID", Toast.LENGTH_SHORT).show();return;}

                            }else{Toast.makeText(Search_All_Customer.this, "Please Enter Zip Code", Toast.LENGTH_SHORT).show();return;}

                        }else{Toast.makeText(Search_All_Customer.this, "Please Enter City Name", Toast.LENGTH_SHORT).show();return;}

                    }else{Toast.makeText(Search_All_Customer.this, "Please Enter Address", Toast.LENGTH_SHORT).show();return;}

                }else{Toast.makeText(Search_All_Customer.this, "Please Enter Mobile Number", Toast.LENGTH_SHORT).show();return;}

            }else{Toast.makeText(Search_All_Customer.this, "Please Enter Father's Name", Toast.LENGTH_SHORT).show();return;}

        }else{Toast.makeText(Search_All_Customer.this, "Please Enter Name", Toast.LENGTH_SHORT).show();return;}
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Search_All_Customer.this);
        String data ="";
        int sizeData = 0;
...
/*
  ...
  */
    ...
    public void backok(View view){
       /* BlurBehind.getInstance().execute(Search_All_Customer.this, new OnBlurCompleteListener() {
            @Override
            public void onBlurComplete() {
                Intent intent = new Intent(Search_All_Customer.this, Launch.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
...
*/
 ...
 /*
                            ...
                            Glide.with(Search_All_Customer.this)
                                    .load(photo)
                                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                                    .error(R.drawable.ic_launcher)
                                    .into(Cadd);

                            //  Picasso.with(Search_All_Customer.this)
...
*/
                            ...
                            new DownloadImageFromInternet(CaddI).execute(product_id_photo.replace("http","https"));
                            new DownloadImageFromInternet(CaddB1).execute(bank_statment_1.replace("http","https"));
                            new DownloadImageFromInternet(CaddB2).execute(bank_statment_2.replace("http","https"));
                ...
                try {
                    ...
                    for(int i=0; i < lengthJsonArr; i++)
                    {
                        ...
                        if (!error) {
                            ...
                            if(under_depart.equals("Sales Person")){
                                intent1 = new Intent(Search_All_Customer.this, Launch.class);
                            }if(under_depart.equals("Manager")){
                                intent1 = new Intent(Search_All_Customer.this, Manager_Launch.class);
                            }if(under_depart.equals("Admin")){
                                intent1 = new Intent(Search_All_Customer.this, Admin_Launch.class);
                            }
...
/*
  ...
  */          //add the row to the ArrayList
        ...
        final CustomAdapter1 adapter=new CustomAdapter1(this, R.layout.z_summry,searchResults);
...
//                bitmap = BitmapFactory.decodeFile(selectedImagePath, o2);
    ...
    public void ImageCropFunction() {
        ...
        try {
            ...
            Toast.makeText(Search_All_Customer.this, "Camera Crop Option not Support!", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void EnableRuntimePermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(Search_All_Customer.this,
                Manifest.permission.CAMERA)) {

            Toast.makeText(Search_All_Customer.this, "CAMERA permission allows us to Access CAMERA app", Toast.LENGTH_LONG).show();

        } else {

            ActivityCompat.requestPermissions(Search_All_Customer.this, new String[]{
...
*/
    ...
    public void selectState(){
        ...
        builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog){
            ...
            */
            ...
            @Override
            public void onNegativeActionClicked(DialogFragment fragment) {
                Toast.makeText(Search_All_Customer.this, "Cancelled" , Toast.LENGTH_SHORT).show();
                super.onNegativeActionClicked(fragment);
            }
        };
    ...
    // Class with extends AsyncTask class
    public class Install_Summ_LongOperation  extends AsyncTask<String, Void, String> {
        private String Error = null;
        private ProgressDialog Dialog = new ProgressDialog(Search_All_Customer.this);
        String data ="";
        int sizeData = 0;
                                        ...
                                        for(int j = 0; j < prods.length();j++){
                                            ...
                                            if(innerElem != null){
                                               // String sku = innerElem.getString("x");
                                                ...
                                                listsub12.add(prods.getJSONObject(j).getString("sub2"));

                                                listsub13.add(prods.getJSONObject(j).getString("sub3"));

                                                listsub14.add(prods.getJSONObject(j).getString("sub4"));

                                                listsub15.add(prods.getJSONObject(j).getString("sub5"));

                                                listsub16.add(prods.getJSONObject(j).getString("sub6"));
    ...
    public void Installment(){
        ...
        String[] names = new String[listsub11.size()];
        names = listsub11.toArray(names);

        String[] teams = new String[listsub12.size()];
        teams = listsub12.toArray(teams);

        String[] message = new String[listsub13.size()];
        message = listsub13.toArray(message);

        String[] Mark_Due = new String[listsub14.size()];
        Mark_Due = listsub14.toArray(Mark_Due);

        String[] Remarks = new String[listsub15.size()];
        Remarks = listsub15.toArray(Remarks);

        String[] no = new String[listsub16.size()];
        no = listsub16.toArray(no);
        ...
        for(int i=0;i<noOfPlayers;i++)
        {
            ...
            temp.put("team", teams[i]);
            temp.put("message", message[i]);
            temp.put("Mark_Due", Mark_Due[i]);
            temp.put("Remarks", Remarks[i]);
            temp.put("no", no[i]);
/*
            if(SelectCat=="Care") {
                //photos = new Integer[]{R.drawable.ic_laptop_mac_black_24dp};
  ...
  */          //add the row to the ArrayList
        ...
        //searchResults=OriginalValues initially
        searchResults=new ArrayList<HashMap<String,Object>>(originalValues);
        final CustomAdapter adapter=new CustomAdapter(this, R.layout.installment,searchResults);
       //  listViewReplacement1 = (LinearLayout) findViewById(R.id.pppp1);
        // NamesRowItemAdapter adapter = new NamesRowItemAdapter(this, namesInList);
        for (int i = 0; i < adapter.getCount(); i++) {
            View view = adapter.getView(i, null, listViewReplacement1);
            listViewReplacement1.addView(view);
        }
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        {
            //ImageView photo;
            TextView name,team,message,AmountI,contact_typetimINS,VeriINS;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null)
            {
                convertView=inflater.inflate(R.layout.installment, null);
                viewHolder=new ViewHolder();

                //cache the views
               // viewHolder.photo=(ImageView) convertView.findViewById(R.id.profile_pic);
                viewHolder.name=(TextView) convertView.findViewById(R.id.Payment_Date);
                viewHolder.team=(TextView) convertView.findViewById(R.id.Cheque_No);
                viewHolder.message=(TextView) convertView.findViewById(R.id.AmountI);
                viewHolder.AmountI=(TextView) convertView.findViewById(R.id.Mark_Due);
                viewHolder.contact_typetimINS=(TextView) convertView.findViewById(R.id.contact_typetimINS);
                viewHolder.VeriINS=(TextView) convertView.findViewById(R.id.VeriINS);
            ...
            viewHolder.AmountI.setText(searchResults.get(position).get("Mark_Due").toString());
            viewHolder.contact_typetimINS.setText(searchResults.get(position).get("Remarks").toString());
            viewHolder.VeriINS.setText(searchResults.get(position).get("no").toString());
...
//if(Product.toString().trim()=="Mobile"){}
    ...
    // Class with extends AsyncTask class
    public class SanctionSindCustomer  extends AsyncTask<String, Void, String> {
        private String Error = null;
        private ProgressDialog Dialog = new ProgressDialog(Search_All_Customer.this);
        String data ="";
        int sizeData = 0;
        ...
        protected String doInBackground(String... params) {
            ...
            try{URL url = new URL(params[0]);
                if(!params[1].equals(""))
                    data +="&" + URLEncoder.encode("cid", "UTF-8") + "="+params[1].toString();
                if(!params[2].equals(""))
                    data +="&" + URLEncoder.encode("email", "UTF-8") + "="+params[2].toString();

                if(!params[3].equals(""))
                    data +="&" + URLEncoder.encode("prim", "UTF-8") + "="+params[3].toString();
                if(!params[4].equals(""))
                    data +="&" + URLEncoder.encode("product_name", "UTF-8") + "="+params[4].toString();
                ...
                try {
                    ...
                    for(int i=0; i < lengthJsonArr; i++)
                    {
                        ...
                        if (!error) {
                            // String PENDING       = jsonChildNode.optString("PENDING").toString();
                          //  Intent intent1 = null;
                        //    intent1 = new Intent(Search_All_Customer.this, Main.class);
                            Toast.makeText(getApplicationContext(), "Sent.", Toast.LENGTH_LONG).show();
                         //   intent1.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                       //     startActivity(intent1);
                     //       finish();
