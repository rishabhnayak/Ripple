...
public class ManageTeam extends AppCompatActivity {
    ...
    String serverURL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/listEMP.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new LongOperation().execute(serverURL,SelectCat,"","");
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(ManageTeam.this);
        String data ="";
        int sizeData = 0;
...
/*
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        {
            ImageView photo;
            TextView name,team,contact_type, mobile, address;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null)
            {
                convertView=inflater.inflate(R.layout.emp_list, null);
        ...
        inputSearch1.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                for(int i=0;i<originalValues1.size();i++)
                {
                    ...
                    String idP=originalValues1.get(i).get("Sid").toString();
    ...
    convertView.setTag(viewHolder);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    BlurBehind.getInstance().execute(ManageTeam.this, new OnBlurCompleteListener() {
                        @Override
                        public void onBlurComplete() {
                            Intent intent = new Intent(ManageTeam.this, Order.class);
