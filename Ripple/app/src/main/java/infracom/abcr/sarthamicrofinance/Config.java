...
public interface Config {
    ...
    static final String YOUR_SERVER_URL   =  "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/";
     
	// Google project id
    static final String GOOGLE_SENDER_ID = "190885707519";
    ...
    static final String DISPLAY_REGISTRATION_MESSAGE_ACTION =
            "infracom.abcr.ripple.DISPLAY_REGISTRATION_MESSAGE";
    
    // Broadcast reciever name to show user messages on screen
    static final String DISPLAY_MESSAGE_ACTION =
        "infracom.abcr.ripple.DISPLAY_MESSAGE";

    // Parse server message with this name
    static final String EXTRA_MESSAGE = "message";

    public static final String URL_UPLOAD_PHOTO="https://www.chhollywoodcasting.com/chhollywoodcasting/newgcm/uploadphoto.php";
