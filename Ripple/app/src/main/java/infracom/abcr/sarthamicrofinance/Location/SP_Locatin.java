...
public class SP_Locatin extends AppCompatActivity{
    ...
    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Location_empList.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sp__locatin);
    ...
    public void showBottomSheet(){
        ...
        ff.setText("Select Sales Person/Dealer");
        listsubR.clear();
        listsub1.clear();
        listsub2.clear();
        listsub3.clear();
    ...
    protected void renderWebPage(String urlToRender){
        webview.setWebViewClient(new WebViewClient(){
            ...
            public void onPageFinished(WebView view, String url){
                ...
                Toast.makeText(SP_Locatin.this,"Loading...",Toast.LENGTH_SHORT).show();
            }
