...
public class business_reports extends AppCompatActivity {
    ...
    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Business_report.php";
...
int dd= 1;
    ...
    public void addone(){
        ...
        String[] status1 = new String[icon.size()];
        status1 = status.toArray(status1);
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(business_reports.this);
        String data ="";
        int sizeData = 0;
...
//                aController.clearUserData();
                                    ...
                                    if(prods != null){
                                        for(int j = 0; j < prods.length();j++){
                                            ...
                                            if(innerElem != null){
                                                ...
                                                status.add(prods.getJSONObject(j).getString("Cstatus"));
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        {
            ImageView photo;
            TextView name,team,city,price,price1,price2,price3,price4,sNo,statusp;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null)
            {
                convertView=inflater.inflate(R.layout.business_report_list, null);
                ...
                viewHolder.statusp=(TextView) convertView.findViewById(R.id.Cstatus);
...
//                prog.stop();
            ...
            Glide.with(business_reports.this)
            ...
            viewHolder.statusp.setText(searchResults.get(position).get("status1").toString());
    ...
    public void datapick(){
        ...
        builder = new infracom.abcr.sarthamicrofinance.material.app.DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(business_reports.this, "Date is " + date, Toast.LENGTH_SHORT).show();
...
/*
        ...
        builder.title("Remarks")
                .positiveAction("View Profile")
                .negativeAction("CANCEL")
  ...
  */          //add the row to the ArrayList
    ...
    private class CustomAdapter1 extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            viewHolder1.name.setText(searchResults1.get(position).get("name").toString());
