...
public class Receivable_Reports extends AppCompatActivity {
    ...
    String serverURL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Receivable_Report.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.receivable__reports_activity);
        ...
        totalRecevi=(TextView)findViewById(R.id.totalRecevi);
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Receivable_Reports.this);
        String data ="";
        int sizeData = 0;
...
//                aController.clearUserData();
                                    ...
                                    if(prods != null){
                                        for(int j = 0; j < prods.length();j++){
                                            ...
                                            if(innerElem != null){
                                                ...
                                                ROI_policy.add(prods.getJSONObject(j).getString("installment_date"));
                                                remarks.add(prods.getJSONObject(j).getString("remarks"));

                                                ROI_Applied.add(prods.getJSONObject(j).getString("ROI_Applied"));
                                                LTV_Policy.add(prods.getJSONObject(j).getString("paid_amount"));
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(Receivable_Reports.this)
    ...
    public void datapick(){
        ...
        builder = new infracom.abcr.sarthamicrofinance.material.app.DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(Receivable_Reports.this, "Date is " + date, Toast.LENGTH_SHORT).show();
