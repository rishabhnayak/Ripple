...
public class Recovery_Person extends AppCompatActivity {
    ...
    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Assign_list.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gps = new GPSTracker(Recovery_Person.this);
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Recovery_Person.this);
        String data ="";
        int sizeData = 0;
...
//                prog.stop();
            ...
            Glide.with(Recovery_Person.this)
    ...
    public void datapick(){
        ...
        builder = new infracom.abcr.sarthamicrofinance.material.app.DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(Recovery_Person.this, "Date is " + date, Toast.LENGTH_SHORT).show();
...
/*
            ...
            */
                ...
                Intent intent = new Intent(Recovery_Person.this, Pay_Installment.class);
