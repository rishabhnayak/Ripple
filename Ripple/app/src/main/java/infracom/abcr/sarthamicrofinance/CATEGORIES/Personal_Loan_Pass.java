...
public class Personal_Loan_Pass extends AppCompatActivity {
    ...
    private static final String TAG = Personal_Loan_Pass.class.getSimpleName();  // Register button
    Button btnRegister;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.personal__loan__pass);
        ...
        if (!aController.isConnectingToInternet()) {
            ...
            aController.showAlertDialog(Personal_Loan_Pass.this,
...
/*
     ...
     //   BlurBehind.getInstance()
       //         .withAlpha(200)
        ...
        gps = new GPSTracker(Personal_Loan_Pass.this);
    ...
    public  void CkeckLoan(){
        ...
        if(am.trim().length() > 0){
            ...
            Toast.makeText(Personal_Loan_Pass.this, "Please Calculate EMI", Toast.LENGTH_SHORT).show();
            return;
        }
...
*/
    ...
    public void CkeckEMI(){
        ...
        if(am.trim().length() > 0){
            ...
            Toast.makeText(Personal_Loan_Pass.this, "Loan Field is empty", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(tun.trim().length() > 0){
            ...
            Toast.makeText(Personal_Loan_Pass.this, "Tuner Field is empty", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if(lm.trim().length() > 0){
            ...
            Toast.makeText(Personal_Loan_Pass.this, "Please Check Loan Amount", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void Post(View view){
        ...
        if(dob1.trim().length() < 1){
            Toast.makeText(Personal_Loan_Pass.this, "Please Select DOB", Toast.LENGTH_SHORT).show();
            return;
        }
                    ...
                    if (State31.trim().length() > 2) {
                        if (LandMark31.trim().length() > 2) {
                            if (Address12.trim().length() > 2) {
                                ...
                                Toast.makeText(Personal_Loan_Pass.this, "Please Permanent Address", Toast.LENGTH_SHORT).show();
                                return;
                            }
                            // if (contactOffice1.trim().length() > 9) {} else { Toast.makeText(Personal_Loan_Pass.this, "Please Office Permanent Contact", Toast.LENGTH_SHORT).show();return; }
                        } else {
                            Toast.makeText(Personal_Loan_Pass.this, "Please Permanent Address Mark", Toast.LENGTH_SHORT).show();
                            return;
                        }
                    } else {
                        Toast.makeText(Personal_Loan_Pass.this, "Please Permanent Address State", Toast.LENGTH_SHORT).show();
                        return;
                    }
                } else {
                    Toast.makeText(Personal_Loan_Pass.this, "Please Permanent Address City", Toast.LENGTH_SHORT).show();
                    return;
                }
            } else {
                Toast.makeText(Personal_Loan_Pass.this, "Please Permanent Address PIN", Toast.LENGTH_SHORT).show();
                return;
            }
        }
                                                                                            ...
                                                                                            //    if(productD1.trim().length() > 2){
                                                                                              //      if(imei1.trim().length() > 2){
                                                                                                ...
                                                                                                if(OccupationS.trim().length() < 2){
                                                                                                    Toast.makeText(Personal_Loan_Pass.this, "Please Select Qualification", Toast.LENGTH_SHORT).show();
                                                                                                    return;
                                                                                                }
                                                                                                if(OuaS.trim().length() < 2){
                                                                                                    Toast.makeText(Personal_Loan_Pass.this, "Please Select Occupation", Toast.LENGTH_SHORT).show();
                                                                                                    return;
                                                                                                }
                                                                                                        ...
                                                                                                        builder
                                                                                                                //.setTitle("............Pay")
                                                                                                                .setMessage("Are you Sure to Save Customer New Personal_Loan_Pass?")
                                                                                                                ...
                                                                                                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                                                                                    public void onClick(DialogInterface dialog, int which) {
                                                                                                                        new LongOperation().execute(serverURL,empname,deviceIMEI,tunName,tunEmail,tunMobile,tunPan,am,lm,tun,addEmiP,totP,lat,lon,regid,num,Mnum,SelectCat, perNew, ProPer,user_id,checkTun,chkType,AdvanceEMIPayP,DownPaymentP,LoanDisbursementP,LTV_Policy,ROI_policy,payedEMI,notPayedEM,
                                                                                                                                ...
                                                                                                                                gender,married,categury,house,Address11,Address12,Address13,OccupationS,OuaS,R_name1, R_Adress1, R_Contact1, R_name2, R_Adress2, R_Contact2, branch_name, branch_id
                                                                                                                        );
                                                                                                 ...
                                                                                                 //   }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Product Model Number/IMEI", Toast.LENGTH_SHORT).show();return;}
                                                                                               // }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Product Details", Toast.LENGTH_SHORT).show();return;}

                                                                                            }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter No of year current Residence", Toast.LENGTH_SHORT).show();return;}
                                                                                        }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Father Name", Toast.LENGTH_SHORT).show();return;}

                                                                                    }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Annual Income ", Toast.LENGTH_SHORT).show();return;}


                                                                                }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Nationality", Toast.LENGTH_SHORT).show();return;}


                                                                               }else{Toast.makeText(Personal_Loan_Pass.this, "Please Residence Contact", Toast.LENGTH_SHORT).show();return;}

                                                                            }else{Toast.makeText(Personal_Loan_Pass.this, "Please Residence Address", Toast.LENGTH_SHORT).show();return;}

                                                                        }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Residence Address Land Mark", Toast.LENGTH_SHORT).show();return;}
                                                                    }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Residence Address State", Toast.LENGTH_SHORT).show();return;}
                                                                }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Residence Address City", Toast.LENGTH_SHORT).show();return;}
                                                            }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Residence Address PIN", Toast.LENGTH_SHORT).show();return;}
                                                        //}else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter DL", Toast.LENGTH_SHORT).show();return;}
                                                    //}else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Aadhar Number", Toast.LENGTH_SHORT).show();return;}
                                                }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter No of Dependents", Toast.LENGTH_SHORT).show();return;}
                                            }else{Toast.makeText(Personal_Loan_Pass.this, "Please Select DOB", Toast.LENGTH_SHORT).show();return;}
                                        }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Mother Name", Toast.LENGTH_SHORT).show();return;}
...
/*
                                        ...
                                        builder
                                                ...
                                                .show();
*/
                                    }else{Toast.makeText(Personal_Loan_Pass.this, "Please Check EMI", Toast.LENGTH_SHORT).show();return;}

                                }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Tuner", Toast.LENGTH_SHORT).show();return;}

                            }else{Toast.makeText(Personal_Loan_Pass.this, "Please Check Loan Amount", Toast.LENGTH_SHORT).show();return;}

                        }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Price", Toast.LENGTH_SHORT).show();return;}

                    }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Customer PAN Number", Toast.LENGTH_SHORT).show();return;}

                }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Customer Mobile Number", Toast.LENGTH_SHORT).show();return;}

            }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Customer Email", Toast.LENGTH_SHORT).show();return;}
        }else{Toast.makeText(Personal_Loan_Pass.this, "Please Enter Customer Name", Toast.LENGTH_SHORT).show();return;}



       /* BlurBehind.getInstance().execute(Personal_Loan_Pass.this, new OnBlurCompleteListener() {
            @Override
            public void onBlurComplete() {
                Intent intent = new Intent(Personal_Loan_Pass.this, MainActivityD.class);
...
*/
    ...
    public void back(View view){
        BlurBehind.getInstance().execute(Personal_Loan_Pass.this, new OnBlurCompleteListener() {
            @Override
            public void onBlurComplete() {
                Intent intent = new Intent(Personal_Loan_Pass.this, Launch.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Personal_Loan_Pass.this);
        String data ="";
        int sizeData = 0;
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                ...
                if(!params[64].equals(""))
                    data +="&" + URLEncoder.encode("rn1", "UTF-8") + "="+params[64].toString();
                if(!params[65].equals(""))
                    data +="&" + URLEncoder.encode("ra1", "UTF-8") + "="+params[65].toString();
                if(!params[66].equals(""))
                    data +="&" + URLEncoder.encode("rc1", "UTF-8") + "="+params[66].toString();
                if(!params[67].equals(""))
                    data +="&" + URLEncoder.encode("rn2", "UTF-8") + "="+params[67].toString();
                if(!params[68].equals(""))
                    data +="&" + URLEncoder.encode("ra2", "UTF-8") + "="+params[68].toString();
                if(!params[69].equals(""))
                    data +="&" + URLEncoder.encode("rc2", "UTF-8") + "="+params[69].toString();

                if(!params[70].equals(""))
                    data +="&" + URLEncoder.encode("branch_name", "UTF-8") + "="+params[70].toString();
                if(!params[71].equals(""))
                    data +="&" + URLEncoder.encode("branch_id", "UTF-8") + "="+params[71].toString();
...
//        txtNamePrice2 = (EditText) v.findViewById(R.id.txtNamePrice2);
        ...
        EmiFinaml = (EditText) v.findViewById(R.id.EmiFinaml1);
...
/*
        ...
        builder = new DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(Personal_Loan_Pass.this, "Date is " + date, Toast.LENGTH_SHORT).show();
  ...
  */
    ...
    public void selectState(){
        ...
        builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                //Toast.makeText(Personal_Loan_Pass.this, "You have selected " + getSelectedValue() + " as phone ringtone.", Toast.LENGTH_SHORT).show();
                super.onPositiveActionClicked(fragment);
            }

            @Override
            public void onNegativeActionClicked(DialogFragment fragment) {
                Toast.makeText(Personal_Loan_Pass.this, "Cancelled" , Toast.LENGTH_SHORT).show();
                super.onNegativeActionClicked(fragment);
            }
        };
    ...
    public void onBackPressed() {
        ...
        builder
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(Personal_Loan_Pass.this, Main.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
