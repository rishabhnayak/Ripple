...
import infracom.abcr.sarthamicrofinance.Profile.SeeAllCustomer;
    ...
    //            .withAlpha(200)
      //          .withFilterColor(Color.parseColor("#222222"))
        ...
        if (!session.isLoggedIn()) {
            ...
            Intent intent = new Intent(Launch.this, RegisterActivity.class);
        ...
        if (!aController.isConnectingToInternet()) {
            ...
            aController.showAlertDialog(Launch.this,
        ...
        textView29.setText("SALES PERSON TASK - "+branch_name+"("+branch_id+")"+" v2.1");
        ...
        list.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                BlurBehind.getInstance().execute(Launch.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(Launch.this, Sartha_Product.class);
        ...
        task.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                BlurBehind.getInstance().execute(Launch.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(Launch.this, MainActivityTask.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        ...
        pListP.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                BlurBehind.getInstance().execute(Launch.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(Launch.this, Sartha_Personal.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
*/
    ...
    public class ManagerLongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Launch.this);
        String data ="";
        int sizeData = 0;
    ...
    public void backokLLL(View view){
        BlurBehind.getInstance().execute(Launch.this, new OnBlurCompleteListener() {
            @Override
            public void onBlurComplete() {
                Intent intent = new Intent(Launch.this, EmpProfile.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
...
public void showMesaage(View view){
    notifi.setText("");
    notifi.setVisibility(View.GONE);
    Intent intent = new Intent(Launch.this, AllShow_Message.class);
    intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    startActivity(intent);
    //finish();
...
//if(Product.toString().trim()=="Mobile"){}
    ...
    public void shoNewsms(View view){
        Intent intent = new Intent(Launch.this, GridViewExample.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
*/
    ...
    public void logt(){
        Intent intent1 = new Intent(Launch.this, RegisterActivity.class);
        startActivity(intent1);
        finish();
        this.finish();
    ...
    public void Recovery(View view){
        ...
        Intent intent = new Intent(Launch.this, Recovery_Person.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
               ...
               String  cc=et_pass.getText().toString().trim();
                if(cc.toString().trim().equals("")){
                    ...
                    Intent intent = new Intent(Launch.this, Search_All_Customer.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
/*
    ...
    public void FullViewP(View view){
        Intent intent = new Intent(Launch.this, SeeAllCustomer.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(Launch.this, android.Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                (Launch.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(Launch.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
