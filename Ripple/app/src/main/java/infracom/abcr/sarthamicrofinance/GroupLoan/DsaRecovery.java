...
import infracom.abcr.sarthamicrofinance.AssignEMP.Pay_Installment;
...
public class DsaRecovery extends AppCompatActivity {
    ...
    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/GroupLoan/Recovery.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dsa_recovery);
        ...
        gps = new GPSTracker(DsaRecovery.this);
        ...
        new LongOperation().execute(serverURL1,cid,"2017-1-31","");
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(DsaRecovery.this);
        String data ="";
        int sizeData = 0;
    ...
    public void datapick(){
        ...
        builder = new infracom.abcr.sarthamicrofinance.material.app.DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(DsaRecovery.this, "Date is " + date, Toast.LENGTH_SHORT).show();
...
/*
            ...
            */
                ...
                Intent intent = new Intent(DsaRecovery.this, Gpay_Installment.class);
