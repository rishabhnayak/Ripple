...
public class DealerLogin extends AppCompatActivity {
    ...
    String serverURL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Salse_All_Customer_list.php";

    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Salse_Customer_list.php";

    String QueryserverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Query_Salse_Customer_list.php";
    ...
    private String Customer_uSERVER_URL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Sales_View_customer_details.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dealer_login);
//        Typeface fontAwesomeFont = Typeface.createFromAsset(getAssets(), "fontawesome-webfont.ttf");
      ...
      //  BlurBehind.getInstance()
        ...
        if (!session.isLoggedIn()) {
            ...
            Intent intent = new Intent(DealerLogin.this, RegisterActivity.class);
        ...
        if (!aController.isConnectingToInternet()) {
            ...
            aController.showAlertDialog(DealerLogin.this,
        ...
        textView29.setText("Dealer - "+branch_name+"("+branch_id+")"+" v1.2");
        ...
        list.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                BlurBehind.getInstance().execute(DealerLogin.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(DealerLogin.this, Sartha_Product.class);
        ...
        task.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                BlurBehind.getInstance().execute(DealerLogin.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(DealerLogin.this, MainActivityTask.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        ...
        pListP.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                BlurBehind.getInstance().execute(DealerLogin.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(DealerLogin.this, Sartha_Personal.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
//		});
    ...
    public class ManagerLongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(DealerLogin.this);
        String data ="";
        int sizeData = 0;
    ...
    public void backokLLL(View view){
        BlurBehind.getInstance().execute(DealerLogin.this, new OnBlurCompleteListener() {
            @Override
            public void onBlurComplete() {
                Intent intent = new Intent(DealerLogin.this, EmpProfile.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
    ...
    public void showMesaage(View view){
        notifi.setText("");
        notifi.setVisibility(View.GONE);
        Intent intent = new Intent(DealerLogin.this, AllShow_Message.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        startActivity(intent);
        //finish();
...
//if(Product.toString().trim()=="Mobile"){}
    ...
    public void shoNewsms(View view){
        Intent intent = new Intent(DealerLogin.this, GridViewExample.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
*/
    ...
    public void logt(){
        Intent intent1 = new Intent(DealerLogin.this, RegisterActivity.class);
        startActivity(intent1);
        finish();
        this.finish();
    ...
    public void Recovery(View view){
        ...
        Intent intent = new Intent(DealerLogin.this, Recovery_Person.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
//                        TunerTypue.setText("Instant EMI Pay is "+E1mT2+"|"+E1mT1+" Type "+addEmi+"(EMI)*"+emi_type1+"="+dounpay.toString()+" and Monthly Installment EMI is "+addEmi);
    ...
    public void INFO(View view){
        mBottomSheetDialog = new BottomSheetDialog(this, R.style.Material_App_BottomSheetDialog);
        View v = LayoutInflater.from(this).inflate(R.layout.z_info, null);
        ViewUtil.setBackground(v, new ThemeDrawable(R.array.bg_window));
    ...
    public void CALLME(View view){
        ...
        callll = callid.getText().toString().trim();
        onCall();
    }
    ...
    public void onCall() {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ...
            callIntent.setData(Uri.parse("tel:"+callll));
  ...
  public void  DelerC(View veew){
      Intent intent = new Intent(getApplicationContext(), SeeAllCustomer.class);
      intent.putExtra("cid", user_id);
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(DealerLogin.this, android.Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                (DealerLogin.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(DealerLogin.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
