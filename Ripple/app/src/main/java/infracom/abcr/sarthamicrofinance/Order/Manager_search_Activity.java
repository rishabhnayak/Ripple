...
public class  Manager_search_Activity extends Fragment {
    ...
    String serverURL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Manager_Customer_list.php";
...
//        aController = (Controller)v.getContext();
        ...
        new LongOperation().execute(serverURL,user_id,"","");
...
//                aController.clearUserData();
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Glide.with(Manager_search_Activity.this)
