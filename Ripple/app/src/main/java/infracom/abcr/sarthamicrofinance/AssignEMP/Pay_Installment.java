...
public class Pay_Installment extends AppCompatActivity {
    ...
    Double intervaltextTT;
      ...
      String Allot="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Pay.php";

    private  String Allot1="https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Payto.php";
    Double pana=0.0;
    Double tot=0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pay__installment_activity);
...
ename=empname;
    ...
    public void queryDo(){
        ...
        builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog){
            ...
            protected void onBuildDone(Dialog dialog) {
                ...
                ccccq.setText(eid);
                bbbbq.setText(ename);
                Glide.with(Pay_Installment.this)
                ...
                if(cc.toString().trim().equals("")){
                  ...
                  //  new ManagerApprove().execute(Allot,cid,eid,deviceIMEI,empname,regid,cc,lat,lon,eid,ename,loan_install_no,installment_date,intervaltext,panaltyPercent.toString(),interPanal.toString(),pana.toString(),tot.toString());
                   // postPay();
                    ...
                    final RadioButton rb2 = (RadioButton)findViewById(R.id.switches_rb2);
                    if(rb2.isChecked()) {
                        new ManagerApprove().execute(Allot, cid, eid, deviceIMEI, empname, regid, cc, lat, lon, bankName, BankBranchName, AccountNum, IFSCC, CHK, installment_date,SlipNo1);
                    }else{
                        new ManagerApprove1().execute(Allot1, cid, eid, deviceIMEI, empname, regid, cc, lat, lon, installment_date,SlipNo1);
                    }
    ...
    public class ManagerApprove  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Pay_Installment.this);
        String data ="";
        int sizeData = 0;
                ...
                try {
                    ...
                    for(int i=0; i < lengthJsonArr; i++)
                    {
                        ...
                        if (!error) {
                            ...
                            intent1 = new Intent(Pay_Installment.this, Launch.class);
                ...
                try {
                    ...
                    for(int i=0; i < lengthJsonArr; i++)
                    {
                        ...
                        if (!error) {
                            ...
                            intent1 = new Intent(Pay_Installment.this, Main.class);
                            intent1.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                            startActivity(intent1);
                ...
                if(BankBranchName.trim().length() > 2){
                    if(AccountNum.trim().length() > 6){
                        //if(IFSCC.trim().length() > 3){
                            ...
                            }else{Toast.makeText(Pay_Installment.this, "Please Enter Cheque Number", Toast.LENGTH_SHORT).show();return;}
                       // }else{Toast.makeText(Pay_Installment.this, "Please Enter IFSC Code", Toast.LENGTH_SHORT).show();return;}
                    }else{Toast.makeText(Pay_Installment.this, "Please Enter Bank Account Number", Toast.LENGTH_SHORT).show();return;}
                }else{Toast.makeText(Pay_Installment.this, "Please Enter Bank Branch Name", Toast.LENGTH_SHORT).show();return;}
            }else{Toast.makeText(Pay_Installment.this, "Please Enter Bank Name", Toast.LENGTH_SHORT).show();return;}
