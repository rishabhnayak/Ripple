...
import infracom.abcr.sarthamicrofinance.AssignEMP.Recovery_EMP_Assign;
...
public class Recovery_Allot extends AppCompatActivity {
    ...
    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Recovery_Reports.php";
    ...
    String serverURLS12 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Recovery_Search_name.php";

    String serverURLS13 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Recovery_Search_name_id.php.php";
    ...
    String product,SelectCat,ProPer,lonper11,lonper12,lonper13,lonper14,lonper15,lonper16,lonper17,lonper18,lonper19,lonper112,installment_date2;
    ...
    // Search EditText
    EditText inputSearch,inputSearchCHQ,inputSearchCHQ2,inputSearchCHQ1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recovery__allot_activity);
        ...
        inputSearchCHQ1 = (EditText) findViewById(R.id.inputSearchCHQ1);
        inputSearchCHQ2 = (EditText) findViewById(R.id.inputSearchCHQ2);
        ...
        inputSearchCHQ1.addTextChangedListener(new TextWatcher() {
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                //get the text in the EditText
                String inputSearchCHQF=inputSearchCHQ.getText().toString();
                String inputSearchCHQF1=inputSearchCHQ1.getText().toString();
                int textLength=inputSearchCHQF.length();
                new LongOperation().execute(serverURLS12,inputSearchCHQF,inputSearchCHQF1,"");
            }
            public void beforeTextChanged(CharSequence s, int start, int count,int after) {}public void afterTextChanged(Editable s) {
            }
        });

        inputSearchCHQ2.addTextChangedListener(new TextWatcher() {
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                //get the text in the EditText
                String inputSearchCHQF=inputSearchCHQ.getText().toString();
                String inputSearchCHQF1=inputSearchCHQ1.getText().toString();
                String inputSearchCHQF2=inputSearchCHQ2.getText().toString();
                int textLength=inputSearchCHQF.length();
                new LongOperation().execute(serverURLS13,inputSearchCHQF,inputSearchCHQF1,inputSearchCHQF2);
            }
            public void beforeTextChanged(CharSequence s, int start, int count,int after) {}public void afterTextChanged(Editable s) {
            }
        });
    ...
    public void addone(){
        ...
        String[] no1 = new String[no.size()];
        no1 = no.toArray(no1);

        String[] city1 = new String[city.size()];
        city1 = city.toArray(city1);

        String[] product_name1 = new String[product_name.size()];
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Recovery_Allot.this);
        String data ="";
        int sizeData = 0;
...
//                aController.clearUserData();
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        {
            ImageView photo;
            TextView name,team,city,price,price1,price2,price3,price4,sNo,ROI_Applied,LTV_Applied,LTV_Policy,installment_date,emp_id,Ename,insttalment,emp;
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if(convertView==null)
            {
                ...
                convertView=inflater.inflate(R.layout.excetion_peport_list, null);
...
//                relativeLayout1=(LinearLayout)convertView.findViewById(R.id.relativeLayout1);
                ...
                viewHolder.emp_id=(TextView) convertView.findViewById(R.id.price8);
                viewHolder.Ename=(TextView) convertView.findViewById(R.id.price9);


                viewHolder.insttalment=(TextView) convertView.findViewById(R.id.insttalment);
                viewHolder.emp=(TextView) convertView.findViewById(R.id.emp);
...
//                prog.stop();
            ...
            Glide.with(Recovery_Allot.this)
            ...
            viewHolder.insttalment.setText(searchResults.get(position).get("installment_date").toString());
            viewHolder.emp.setText(searchResults.get(position).get("Ename").toString()+"("+searchResults.get(position).get("emp_id").toString()+")");
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent = new Intent(Recovery_Allot.this, Recovery_EMP_Assign.class);
                    intent.putExtra("cid", lonper11);
                    intent.putExtra("cname", lonper12);
                    intent.putExtra("sts", "Recovery");
                    intent.putExtra("date", installment_date2);
    ...
    public void datapick(){
        ...
        builder = new infracom.abcr.sarthamicrofinance.material.app.DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(Recovery_Allot.this, "Date is " + date, Toast.LENGTH_SHORT).show();
