package infracom.abcr.sarthamicrofinance.ImageUp.permission;
...
public class PermissionsActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_PERMISSIONS = "infracom.abcr.sarthamicrofinance.EXTRA_PERMISSIONS";
