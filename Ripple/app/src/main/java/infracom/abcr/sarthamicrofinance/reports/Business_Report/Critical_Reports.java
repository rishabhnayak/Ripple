...
public class Critical_Reports extends AppCompatActivity {
    ...
    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Critical_Business_report.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.critical__reports_activity);
...
/*
  ...
  */          //add the row to the ArrayList
    ...
    public class LongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Critical_Reports.this);
        String data ="";
        int sizeData = 0;
...
//                aController.clearUserData();
    ...
    private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
    {
        ...
        {
            ImageView photo;
            TextView name,team,city,price,price1,price2,price3,price4,sNo;
...
//                prog.stop();
            ...
            Glide.with(Critical_Reports.this)
    ...
    public void datapick(){
        ...
        builder = new infracom.abcr.sarthamicrofinance.material.app.DatePickerDialog.Builder(isLightTheme ? R.style.Material_App_Dialog_DatePicker_Light :  R.style.Material_App_Dialog_DatePicker){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                m1=m1+1;
                int d=dialog.getDay();
                Toast.makeText(Critical_Reports.this, "Date is " + date, Toast.LENGTH_SHORT).show();
