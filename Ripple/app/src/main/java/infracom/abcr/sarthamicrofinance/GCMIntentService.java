...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        Log.d("NAME", RMainActivity.name);
        
        aController.register(context, RMainActivity.name, RMainActivity.email, registrationId,RMainActivity.imei,RMainActivity.latitude,RMainActivity.longitude, RMainActivity.user_id, RMainActivity.D_under_departKEY,RMainActivity.branch_name,RMainActivity.branch_id);
        
        DBAdapter.addDeviceData(RMainActivity.name, RMainActivity.email, registrationId, RMainActivity.imei, RMainActivity.user_id, RMainActivity.D_under_departKEY,RMainActivity.branch_name,RMainActivity.branch_id);
    ...
    protected void onUnregistered(Context context, String registrationId) {
        ...
        aController.unregister(context, registrationId,RMainActivity.imei);
    }
...
String image = "";
		...
		if (StringLength > 0) {
         ...
         UserData userdata = new UserData(1,imei,title,message,image);
    ...
    private static void generateNotification(Context context,String title, String message, String imei) {
        ...
        Intent notificationIntent = new Intent(context, SendPushNotification.class);
      ...
      //  notification.flags |= Notification.FLAG_AUTO_CANCEL;
       ...
       // notification.defaults |= Notification.DEFAULT_SOUND;
        ...
        b.setAutoCancel(true)
                ...
                .setSmallIcon(icon)
                .setTicker("Sartha Micro Finance")
                .setContentTitle(title)
                .setContentText(message)
                .setDefaults(Notification.DEFAULT_LIGHTS| Notification.DEFAULT_SOUND)
                .setContentIntent(contentIntent)
                .setContentInfo("Sartha Info");
