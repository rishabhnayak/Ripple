...
public class Admin_Launch extends AppCompatActivity {
    ...
    String serverURL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Admin_All_Customer_list.php";

    String serverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Admin_Customer_list.php";
    String serverURL13 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Admin_Customer_listSANC.php";

    String QueryserverURL1 = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/Query_Admin_Customer_list.php";
    ...
    String PENDING,sms_status,CLEAR,DONE,TOTAL,FINANCIAL,DISBURSEMENT,iQuery,SANCTION;
    ProgressDialog dialog;
    public String user_id, email, name, lastname, mobile, fullname,sts,regid;
    private String Customer_uSERVER_URL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/Admin_View_customer_details.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin__launch);
...
//        Typeface fontAwesomeFont = Typeface.createFromAsset(getAssets(), "fontawesome-webfont.ttf");
     ...
     //   adminfinancial= (TextView)findViewById(R.id.adminfinancial);
        ...
        if (!aController.isConnectingToInternet()) {
            ...
            aController.showAlertDialog(Admin_Launch.this,
        ...
        textView29.setText("Admin TASK - "+branch_name+"("+branch_id+")"+" v2.1");
...
/*
        list.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                ...
                BlurBehind.getInstance().execute(Admin_Launch.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(Admin_Launch.this, MainActivityD.class);
        ...
        task.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View arg0) {
                BlurBehind.getInstance().execute(Admin_Launch.this, new OnBlurCompleteListener() {
                    @Override
                    public void onBlurComplete() {
                        Intent intent = new Intent(Admin_Launch.this, MainActivityTask.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
//		});
    ...
    public class ManagerLongOperation  extends AsyncTask<String, Void, String> {
        ...
        private ProgressDialog Dialog = new ProgressDialog(Admin_Launch.this);
        String data ="";
        int sizeData = 0;
                           ...
                           // }
                            ...
                            if(SANCTION.equals("0")){
                               ...
                               if(FINANCIAL.equals("0")){
                                ...
                                textViewDone.setVisibility(View.VISIBLE);
                                textViewDone.setText(FINANCIAL);
                            }
                            // if(Admin add Manager and Manager Add Sales Person and Sales person can add Customer.){}
    ...
    public void backokLLL(View view){
        BlurBehind.getInstance().execute(Admin_Launch.this, new OnBlurCompleteListener() {
            @Override
            public void onBlurComplete() {
                Intent intent = new Intent(Admin_Launch.this, EmpProfile.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
    ...
    public void showMesaage(View view){
        ...
        notifi.setText("");
        notifi.setVisibility(View.GONE);
        Intent intent = new Intent(Admin_Launch.this, AllShow_Message.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        startActivity(intent);
        //finish();
...
//        aController = (Controller)v.getContext();
        ...
        if(task.equals("TOTAL")){
            ...
            if(task.equals("QUERY")){
                new LongOperation().execute(QueryserverURL1,cid,"","");
...
//if(Product.toString().trim()=="Mobile"){}
    ...
    public void shoNewsms(View view){
        Intent intent = new Intent(Admin_Launch.this, GridViewExample.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    public void addEMP(){
        ...
        addDSA.setVisibility(View.GONE);

        addp.setText("Add New Admin");

        addp.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {

                Intent intent = new Intent(Admin_Launch.this, Add_EMP.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        ...
        removep.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Admin_Launch.this, LestOFEMP.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    public void logt(){
        Intent intent1 = new Intent(Admin_Launch.this, RegisterActivity.class);
        startActivity(intent1);
        finish();
        this.finish();
        ...
        startActivity(intent);
        //Intent intent = new Intent(Admin_Launch.this, RegisterActivity.class);
        //startActivity(intent);
        //finish();
    }
    ...
    public void goFunc(){
        ...
        BusinessR.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Admin_Launch.this, business_reports.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
...
*/
    ...
    public void ReportF(){
        ...
        add.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Admin_Launch.this, Business_report_list.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
        ...
        ER.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Admin_Launch.this, Exception_Peport.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
        ...
        TR.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Admin_Launch.this, Trending_Report.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
        ...
        RR.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Admin_Launch.this, Receivable_Reports.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
        ...
        aCRdd.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                Intent intent = new Intent(Admin_Launch.this, Critical_Reports.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
                //finish();
            }
        ...
        builder = new SimpleDialog.Builder(isLightTheme ? R.style.SimpleDialogLight : R.style.SimpleDialog){
            ...
            public void onPositiveActionClicked(DialogFragment fragment) {
                ...
                if(cc.toString().trim().equals("")){
                    ...
                    Intent intent = new Intent(Admin_Launch.this, Search_All_Customer.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
...
/*
    ...
    public void goo(){
        ...
        loan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Admin_Launch.this, SP_Locatin.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
        ...
        noc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Admin_Launch.this, Customer_Locatin.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(Admin_Launch.this, android.Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission
                (Admin_Launch.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions(Admin_Launch.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION}, REQUEST_LOCATION);
