...
public class SendPushNotification extends AppCompatActivity {
	...
	String serverURL = "https://sarthamicrofinance.com/admin/gcm_Device_to/gcm_server_files/TAB_File/NewJson/MassageFatch.php";
	String imei;
	String user_id;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		gps = new GPSTracker(SendPushNotification.this);
...
/*
	...
	private class CustomAdapter extends ArrayAdapter<HashMap<String, Object>>
	{
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			Glide.with(SendPushNotification.this)
...
//if(Product.toString().trim()=="Mobile"){}
	...
	public void  subProduct(final String productsub,final String per){
		...
		BlurBehind.getInstance().execute(SendPushNotification.this, new OnBlurCompleteListener() {
			@Override
			public void onBlurComplete() {
				Intent intent = new Intent(SendPushNotification.this, Order.class);
